...
def read_process_and_output(folder_path, match_I_dir, match_Q_dir, img_save_path):
    import numpy as np
    import matplotlib.pyplot as plt
    ...
    plt.savefig(os.path.join(img_save_path, "A-Scan.png"))
    plt.close()
    # plt.show()
    ...
    plt.savefig(os.path.join(img_save_path, "B-Scan.png"))
    plt.close()
    # plt.show()
    ...
    for unit_idx in range(num_units):
        ...
        plt.ylabel("Amplitude")
        # plt.show()
        plt.savefig(os.path.join(img_save_path, f"Unit_{unit_idx}_Time_Domain.png"))
        plt.close()
    # 保存频域图像
    for unit_idx in range(num_units):
        print(unit_idx)
        ...
        # plt.show()
        plt.savefig(os.path.join(img_save_path, f"Unit_{unit_idx}_Frequency_Domain.png"))
        plt.close()
    return results
